...
led_marquee.path = minetest.get_modpath(minetest.get_current_modname())
led_marquee.gettext, led_marquee.ngettext = dofile(led_marquee.path.."/intllib.lua")
local S = led_marquee.gettext
local NS = led_marquee.ngettext
