		...
		if open_chests[pn] then
			...
			if fields.quit then
				...
				minetest.after(0.2, function()
					minetest.swap_node(pos, { name = "lib_chests:" .. swap, param2 = node.param2 })
...
local old_chest_def = table.copy(minetest.registered_items["lib_chests:chest"])
local old_chest_open_def = table.copy(minetest.registered_items["lib_chests:chest_open"])
local old_chest_locked_def = table.copy(minetest.registered_items["lib_chests:chest_locked"])
local old_chest_locked_open_def = table.copy(minetest.registered_items["lib_chests:chest_locked_open"])
	...
	on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
		...
		if not chest_lid_obstructed(pos) then
			minetest.swap_node(pos,
					{ name = "lib_chests:" .. "chest_locked" .. "_open",
					param2 = node.param2 })
		end
...
minetest.override_item("lib_chests:chest", override)
minetest.override_item("lib_chests:chest_open", override_open)
minetest.override_item("lib_chests:chest_locked", override_protected)
minetest.override_item("lib_chests:chest_locked_open", override_protected_open)
