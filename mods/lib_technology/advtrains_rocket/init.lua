...
core.register_node("advtrains_rocket:barrel", {
	description = "barrel",
	...
	on_blast = function(pos)
		local drops = {}
		gal.get_inventory_drops(pos, "main", drops)
		drops[#drops+1] = "advtrains_rocket:barrel"
		core.remove_node(pos)
		return drops
	end,
})

core.register_node("advtrains_rocket:barrel_stack", {
	...
	on_blast = function(pos)
		local drops = {}
		gal.get_inventory_drops(pos, "main", drops)
		drops[#drops+1] = "advtrains_rocket:barrel_stack"
		core.remove_node(pos)
		return drops
	end,
})
...
core.register_craft({
	output = 'advtrains_rocket:barrel',
	recipe = {
		{'group:wood', 'group:wood', 'group:wood'},
...
core.register_craft({
	output = 'advtrains_rocket:barrel_stack',
	recipe = {
		{'', 'advtrains_train_rocket:barrel', ''},
