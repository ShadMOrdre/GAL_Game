...
local p = {
  {act = 'fill', node = 'air', line = N["SB"], treasure = 1, coords = {1, 78, 21, 38, 1, 78}},
  {act = 'fill', node = N["SB"], coords = {1, 78, 50, 1, 1, 78}},
  {act = 'fill', node = 'air', coords = {5, 70, 50, 1, 5, 70}},
  {act = 'stair', node = N["ST"], depth = 3, height = 4, param2 = 2, coords = {1, 2, 21, 30, 25, 30}},
  {act = 'stair', node = N["ST"], depth = 3, height = 4, param2 = 0, coords = {77, 2, 21, 30, 25, 30}},
}
...
for z = 7, 78, 9 do
  for x = 7, 78, 9 do
    local i = {act = 'fill', node = N["SB"], coords = {z, 2, 21, 38, x, 2}}
    table.insert(p, i)
    if geomoria_mod.cheap_lighting then
      for y = 25, 57, 9 do
        i = {act = 'fill', node = N["ML"], coords = {z, 2, y, 1, x, 2}}
        table.insert(p, i)
      end
    end
  end
...
p = {
  ...
  {act = 'fill', node = N["WS"], treasure = 5, coords = {20, 51, 11, 10, 11, 50}},
  {act = 'fill', node = N["S0"], coords = {38, 17, 11, 10, 30, 16}},
  {act = 'fill', node = N["S0"], coords = {39, 2, 11, 10, 11, 19}},
  {act = 'fill', node = N["WS"], treasure = 3, coords = {49, 30, 11, 5, 62, 17}},
  {act = 'fill', node = N["WS"], coords = {17, 32, 11, 2, 69, 2}},
  {act = 'fill', node = N["WS"], coords = {43, 2, 11, 2, 61, 10}},
  {act = 'fill', node = N["WS"], coords = {17, 2, 11, 2, 23, 46}},
  {act = 'fill', node = N["WS"], treasure = 1, coords = {1, 18, 11, 5, 1, 22}},
  ...
  {act = 'ladder', node = N["LS"], param2 = 5, coords = {78, 1, 11, 10, 62, 1}},
  {act = 'ladder', node = N["LS"], param2 = 4, coords = {20, 1, 21, 20, 60, 1}},

  {act = 'fill', node = 'air', coords = {20, 51, 41, 5, 61, 9}},
  {act = 'fill', node = 'air', coords = {11, 9, 41, 5, 11, 59}},
  {act = 'stair', node = N["ST"], height = 4, param2 = 2, coords = {16, 2, 21, 20, 36, 20}},
  {act = 'stair', node = N["ST"], param2 = 3, coords = {1, 10, 41, 10, 39, 2}},
  {act = 'stair', node = N["ST"], param2 = 0, coords = {39, 2, 41, 10, 69, 10}},

  {act = 'fill', node = 'air', coords = {71, 8, 51, 3, 39, 2}},
  {act = 'stair', node = N["ST"], depth = 2, param2 = 2, coords = {69, 2, 41, 10, 51, 10}},
  ...
  {act = 'fill', node = N["S0"], coords = {37, 5, 51, 6, 40, 5}},
...
p = {
  ...
  {act = 'stair', node = N["ST"], param2 = 3, coords = {33, 10, 21, 10, 14, 1}},
  {act = 'fill', node = 'air', coords = {61, 14, 31, 4, 56, 19}},
  {act = 'ladder', node = N["LS"], param2 = 4, coords = {63, 1, 21, 10, 74, 1}},
  {act = 'stair', node = N["ST"], param2 = 0, coords = {73, 2, 21, 10, 49, 10}},
  {act = 'stair', node = N["ST"], param2 = 1, coords = {6, 10, 21, 10, 57, 2}},
  ...
  {act = 'stair', node = N["ST"], param2 = 2, coords = {67, 2, 31, 10, 46, 10}},
  ...
  {act = 'stair', node = N["ST"], param2 = 1, coords = {67, 10, 41, 10, 11, 2}},
...
for x = 9, 69, 15 do
  ...
  for z = 44, 74, 6 do
    ...
    table.insert(p, {act = 'fill', node = N["DR"], param2 = 3, coords = {x - 1, 1, 51, 1, z, 1}})
    table.insert(p, {act = 'fill', node = 'air', coords = {x + 2, 1, 51, 2, z, 1}})
    table.insert(p, {act = 'fill', node = N["DL"], param2 = 1, coords = {x + 2, 1, 51, 1, z, 1}})
  end
end
...
p = {
  ...
  {act = 'fill', node = 'air', floor = N["SB"], coords = {1, 78, 21, 15, 17, 6}},
  ...
  {act = 'fill', node = 'air', treasure = 3, floor = N["SB"], coords = {30, 20, 21, 15, 30, 20}},
  ...
  {act = 'stair', node = N["ST"], param2 = 1, coords = {3, 10, 21, 10, 65, 2}},
  {act = 'stair', node = N["ST"], param2 = 1, coords = {12, 10, 21, 10, 9, 2}},
  {act = 'stair', node = N["ST"], param2 = 1, coords = {50, 10, 21, 10, 9, 2}},
  {act = 'stair', node = N["ST"], param2 = 3, coords = {65, 10, 21, 10, 59, 2}},
  {act = 'stair', node = N["ST"], param2 = 2, coords = {32, 2, 21, 10, 61, 10}},
  {act = 'ladder', node = N["LS"], param2 = 3, coords = {4, 1, 21, 10, 25, 1}},
  {act = 'fill', node = 'air', coords = {59, 1, 21, 3, 9, 2}},

  {act = 'fill', node = 'air', coords = {63, 2, 41, 3, 17, 31}},
  {act = 'stair', node = N["ST"], param2 = 2, coords = {63, 2, 31, 10, 48, 10}},
  {act = 'stair', node = N["ST"], param2 = 0, coords = {63, 2, 31, 10, 7, 10}},

  {act = 'fill', node = N["S0"], coords = {20, 2, 30, 1, 17, 6}},
  {act = 'fill', node = N["S0"], coords = {39, 2, 30, 1, 17, 6}},
  {act = 'fill', node = N["S0"], coords = {58, 2, 30, 1, 17, 6}},
  {act = 'fill', node = N["S0"], coords = {56, 6, 30, 1, 63, 3}},
  {act = 'fill', node = N["S0"], coords = {39, 2, 30, 1, 30, 20}},
  {act = 'fill', node = N["S0"], coords = {30, 20, 30, 1, 39, 2}},
...
p = {
  {param = 'dry'},
  {act = 'fill', node = 'air', floor = N["SB"], coords = {1, 78, 21, 5, 1, 78}},
  {act = 'fill', node = N["S0"], coords = {9, 62, 21, 1, 9, 62}},
  {act = 'fill', node = N["S0"], coords = {9, 62, 23, 5, 9, 62}},
  {act = 'fill', node = 'air', coords = {10, 60, 11, 25, 10, 60}},
  {act = 'fill', node = N["LV"], coords = {10, 60, 11, 5, 10, 60}},
  {act = 'fill', node = N["S0"], coords = {25, 30, 11, 9, 25, 30}},
  {act = 'fill', node = N["SB"], coords = {25, 30, 20, 1, 25, 30}},
  {act = 'fill', node = N["S0"], coords = {39, 2, 20, 1, 55, 15}},
  {act = 'fill', node = N["S0"], coords = {39, 2, 20, 1, 10, 15}},
  {act = 'fill', node = N["S0"], coords = {10, 15, 20, 1, 39, 2}},
  {act = 'fill', node = N["S0"], coords = {55, 15, 20, 1, 39, 2}},
  ...
  {act = 'fill', node = N["S0"], coords = {37, 6, 20, 2, 37, 6}},
  {act = 'fill', node = N["LV"], coords = {38, 4, 20, 2, 38, 4}},
}
...
local node = geomoria_mod.clone_node(N["WS"])
node.liquid_range = 2
...
local node = geomoria_mod.clone_node(N["WF"])
node.liquid_range = 2
node.liquid_alternative_flowing = "geomoria:water_flowing_tame"
node.liquid_alternative_source = "geomoria:water_source_tame"
...
p = {
  ...
  {act = 'fill', node = N["S0"], coords = {18, 4, 11, 6, 8, 4}},
  {act = 'fill', node = N["S0"], coords = {18, 4, 11, 6, 23, 4}},
  {act = 'fill', node = N["S0"], coords = {18, 4, 11, 6, 38, 4}},
  {act = 'fill', node = N["S0"], coords = {18, 4, 11, 6, 53, 4}},
  {act = 'fill', node = N["S0"], coords = {18, 4, 11, 6, 68, 4}},
  {act = 'fill', node = N["WS"], coords = {19, 2, 11, 10, 9, 2}},
  {act = 'fill', node = N["WS"], coords = {19, 2, 11, 10, 24, 2}},
  {act = 'fill', node = N["WS"], coords = {19, 2, 11, 10, 39, 2}},
  {act = 'fill', node = N["WS"], coords = {19, 2, 11, 10, 54, 2}},
  {act = 'fill', node = N["WS"], coords = {19, 2, 11, 10, 69, 2}},

  {act = 'stair', node = N["ST"], param2 = 1, coords = {61, 10, 11, 10, 59, 2}},
  {act = 'stair', node = N["ST"], param2 = 2, coords = {39, 2, 11, 10, 1, 10}},
  {act = 'stair', node = N["ST"], param2 = 3, coords = {39, 10, 11, 10, 19, 2}},
  {act = 'fill', node = 'air', coords = {39, 2, 11, 3, 11, 14}},
  {act = 'fill', node = N["S0"], coords = {61, 1, 21, 6, 59, 2}},

  {act = 'cylinder', node = 'air', axis = 'z', coords = {10, 20, 15, 20, 1, 79}},
  {act = 'fill', node = N["S0"], coords = {10, 20, 15, 6, 1, 79}},
  {act = 'fill', node = 'air', floor = N["SB"], coords = {10, 20, 21, 4, 1, 79}},
  ...
  {act = 'fill', node = N["S0"], coords = {15, 10, 21, 1, 5, 10}},
  {act = 'fill', node = N["WS"], coords = {16, 8, 21, 1, 6, 8}},
  {act = 'fill', node = N["S0"], coords = {19, 2, 21, 2, 9, 2}},
  {act = 'fill', node = 'geomoria:water_source_tame', coords = {19, 2, 23, 1, 9, 2}},
  {act = 'fill', node = N["S0"], coords = {15, 10, 21, 1, 20, 10}},
  {act = 'fill', node = N["WS"], coords = {16, 8, 21, 1, 21, 8}},
  {act = 'fill', node = N["S0"], coords = {19, 2, 21, 2, 24, 2}},
  {act = 'fill', node = 'geomoria:water_source_tame', coords = {19, 2, 23, 1, 24, 2}},
  {act = 'fill', node = N["S0"], coords = {15, 10, 21, 1, 35, 10}},
  {act = 'fill', node = N["WS"], coords = {16, 8, 21, 1, 36, 8}},
  {act = 'fill', node = N["S0"], coords = {19, 2, 21, 2, 39, 2}},
  {act = 'fill', node = 'geomoria:water_source_tame', coords = {19, 2, 23, 1, 39, 2}},
  {act = 'fill', node = N["S0"], coords = {15, 10, 21, 1, 50, 10}},
  {act = 'fill', node = N["WS"], coords = {16, 8, 21, 1, 51, 8}},
  {act = 'fill', node = N["S0"], coords = {19, 2, 21, 2, 54, 2}},
  {act = 'fill', node = 'geomoria:water_source_tame', coords = {19, 2, 23, 1, 54, 2}},
  {act = 'fill', node = N["S0"], coords = {15, 10, 21, 1, 65, 10}},
  {act = 'fill', node = N["WS"], coords = {16, 8, 21, 1, 66, 8}},
  {act = 'fill', node = N["S0"], coords = {19, 2, 21, 2, 69, 2}},
  ...
  {act = 'fill', node = N["S0"], coords = {54, 4, 11, 6, 49, 4}},
  ...
  {act = 'stair', node = N["ST"], param2 = 3, coords = {61, 10, 21, 10, 19, 2}},
  {act = 'stair', node = N["ST"], param2 = 1, coords = {41, 10, 21, 10, 69, 2}},
}
...
p = {
  ...
  {act = 'stair', node = N["ST"], param2 = 1, coords = {61, 10, 21, 10, 75, 2}},
  {act = 'stair', node = N["ST"], param2 = 3, coords = {9, 10, 21, 10, 3, 2}},
  {act = 'fill', node = N["DD"], coords = {5, 70, 29, 2, 5, 70}},
  {act = 'fill', node = geomoria_mod.treasure_chest, random = 200, coords = {5, 70, 29, 1, 5, 70}},
  {act = 'fill', node = 'air', coords = {5, 70, 31, 7, 5, 70}},
  {act = 'fill', node = N["mb"], random = 4, coords = {5, 70, 31, 1, 5, 70}},
  {act = 'fill', node = 'air', coords = {71, 6, 31, 3, 75, 2}},
  {act = 'fill', node = 'air', coords = {3, 6, 31, 3, 3, 2}},

  {act = 'stair', node = N["ST"], param2 = 2, coords = {75, 2, 31, 10, 65, 10}},
  {act = 'stair', node = N["ST"], param2 = 0, coords = {3, 2, 31, 10, 5, 10}},

  {act = 'fill', node = N["DD"], coords = {5, 70, 39, 2, 5, 70}},
  {act = 'fill', node = geomoria_mod.treasure_chest, random = 200, coords = {5, 70, 39, 1, 5, 70}},
  {act = 'fill', node = 'air', coords = {5, 70, 41, 7, 5, 70}},
  {act = 'fill', node = N["mb"], random = 4, coords = {5, 70, 41, 1, 5, 70}},
...
p = {
  ...
  {act = 'stair', node = N["ST"], param2 = 2, coords = {59, 2, 21, 10, 67, 10}},
  {act = 'stair', node = N["ST"], param2 = 0, coords = {59, 2, 21, 10, 3, 10}},
  {act = 'stair', node = N["ST"], param2 = 0, coords = {19, 2, 21, 10, 3, 10}},
  {act = 'stair', node = N["ST"], param2 = 3, coords = {67, 10, 21, 10, 19, 2}},
  {act = 'stair', node = N["ST"], param2 = 3, coords = {67, 10, 21, 10, 59, 2}},
  {act = 'stair', node = N["ST"], param2 = 1, coords = {3, 10, 21, 10, 59, 2}},
  {act = 'stair', node = N["ST"], param2 = 1, coords = {3, 10, 21, 10, 19, 2}},
  {act = 'stair', node = N["ST"], param2 = 2, coords = {19, 2, 21, 10, 67, 10}},
  ...
  {act = 'stair', node = N["ST"], param2 = 2, coords = {65, 2, 31, 8, 51, 8}},
  {act = 'stair', node = N["ST"], param2 = 0, coords = {65, 2, 31, 8, 21, 8}},
  {act = 'stair', node = N["ST"], param2 = 2, coords = {13, 2, 31, 8, 51, 8}},
  {act = 'stair', node = N["ST"], param2 = 0, coords = {13, 2, 31, 8, 21, 8}},
  {act = 'stair', node = N["ST"], param2 = 3, coords = {51, 8, 31, 8, 65, 2}},
  {act = 'stair', node = N["ST"], param2 = 1, coords = {21, 8, 31, 8, 65, 2}},
  {act = 'stair', node = N["ST"], param2 = 3, coords = {51, 8, 31, 8, 13, 2}},
  {act = 'stair', node = N["ST"], param2 = 1, coords = {21, 8, 31, 8, 13, 2}},
}
...
p = {
  ...
  {act = 'fill', node = N["DL"], param2 = 3, coords = {0, 1, 21, 1, 59, 1}},
  {act = 'fill', node = N["DR"], param2 = 3, coords = {0, 1, 21, 1, 60, 1}},
  {act = 'fill', node = N["DR"], param2 = 1, coords = {79, 1, 21, 1, 59, 1}},
  {act = 'fill', node = N["DL"], param2 = 1, coords = {79, 1, 21, 1, 60, 1}},

  {act = 'fill', node = N["DL"], param2 = 3, coords = {0, 1, 21, 1, 19, 1}},
  {act = 'fill', node = N["DR"], param2 = 3, coords = {0, 1, 21, 1, 20, 1}},
  {act = 'fill', node = N["DR"], param2 = 1, coords = {79, 1, 21, 1, 19, 1}},
  {act = 'fill', node = N["DL"], param2 = 1, coords = {79, 1, 21, 1, 20, 1}},

  {act = 'fill', node = N["DL"], param2 = 0, coords = {39, 1, 21, 1, 79, 1}},
  {act = 'fill', node = N["DR"], param2 = 0, coords = {40, 1, 21, 1, 79, 1}},
  {act = 'fill', node = N["DR"], param2 = 2, coords = {39, 1, 21, 1, 0, 1}},
  {act = 'fill', node = N["DL"], param2 = 2, coords = {40, 1, 21, 1, 0, 1}},

  {act = 'fill', node = 'air', coords = {37, 1, 21, 2, 71, 2}},
  {act = 'fill', node = 'air', coords = {42, 1, 21, 2, 71, 2}},
  {act = 'fill', node = N["DR"], param2 = 1, coords = {37, 1, 21, 1, 71, 1}},
  {act = 'fill', node = N["DL"], param2 = 1, coords = {37, 1, 21, 1, 72, 1}},
  {act = 'fill', node = N["DL"], param2 = 3, coords = {42, 1, 21, 1, 71, 1}},
  {act = 'fill', node = N["DR"], param2 = 3, coords = {42, 1, 21, 1, 72, 1}},

  {act = 'fill', node = 'air', coords = {37, 1, 21, 2, 7, 2}},
  {act = 'fill', node = 'air', coords = {42, 1, 21, 2, 7, 2}},
  {act = 'fill', node = N["DR"], param2 = 1, coords = {37, 1, 21, 1, 7, 1}},
  {act = 'fill', node = N["DL"], param2 = 1, coords = {37, 1, 21, 1, 8, 1}},
  {act = 'fill', node = N["DL"], param2 = 3, coords = {42, 1, 21, 1, 7, 1}},
  {act = 'fill', node = N["DR"], param2 = 3, coords = {42, 1, 21, 1, 8, 1}},

  {act = 'fill', node = N["DR"], param2 = 1, coords = {79, 1, 21, 1, 39, 1}},
  {act = 'fill', node = N["DL"], param2 = 1, coords = {79, 1, 21, 1, 40, 1}},

  {act = 'fill', node = 'air', coords = {9, 1, 21, 2, 39, 2}},
  {act = 'fill', node = N["DR"], param2 = 1, coords = {9, 1, 21, 1, 39, 1}},
  {act = 'fill', node = N["DL"], param2 = 1, coords = {9, 1, 21, 1, 40, 1}},
  ...
  {act = 'ladder', node = N["LS"], param2 = 2, coords = {28, 1, 21, 10, 27, 1}},
}
...
for _, o in pairs({0, 43}) do
  for x = 4 + o, 32 + o, 4 do
    for _, y in pairs({57, 17}) do
      ...
      table.insert(p, i)
      i = {act = 'fill', node = N["DL"], param2 = 0, coords = {x, 1, 21, 1, y + 5, 1}}
      table.insert(p, i)
      ...
      table.insert(p, i)
      i = {act = 'fill', node = N["DL"], param2 = 2, coords = {x, 1, 21, 1, y, 1}}
      table.insert(p, i)
...
p = {
  ...
  {act = 'fill', node = N["S0"], coords = {1, 78, 0, 21, 1, 78}},
  {act = 'fill', node = N["SB"], coords = {1, 78, 20, 1, 1, 78}},
}


geomoria_mod.stair_height = {
  {act = 'fill', node = N["S0"], coords = {26, 5, 0, 5, 23, 31}},
  {act = 'fill', node = N["S0"], coords = {26, 28, 0, 26, 49, 5}},
  {act = 'fill', node = N["S0"], coords = {49, 5, 19, 27, 29, 28}},
  {act = 'fill', node = N["S0"], coords = {29, 25, 39, 27, 26, 5}},
  {act = 'fill', node = N["S0"], coords = {26, 5, 59, 21, 26, 28}},
  {act = 'fill', node = 'air', coords = {27, 3, 0, 4, 47, 6}},
  {act = 'stair', node = N["ST"], height = 4, depth = 3, param2 = 1, coords = {30, 20, 0, 20, 50, 3}},
  {act = 'fill', node = 'air', coords = {47, 6, 20, 4, 50, 3}},
  {act = 'stair', node = N["ST"], height = 4, depth = 3, param2 = 2, coords = {50, 3, 20, 20, 30, 20}},
  {act = 'fill', node = 'air', coords = {50, 3, 40, 4, 27, 6}},
  {act = 'stair', node = N["ST"], height = 4, depth = 3, param2 = 3, coords = {30, 20, 40, 20, 27, 3}},
  {act = 'fill', node = 'air', coords = {27, 6, 60, 4, 27, 3}},
  {act = 'stair', node = N["ST"], height = 4, depth = 3, param2 = 0, coords = {27, 3, 60, 21, 30, 20}},
}
...
p = {
  ...
  {act = 'fill', node = N["S0"], coords = {35, 40, 31, 20, 35, 40}},
  {act = 'fill', node = N["SB"], coords = {35, 40, 50, 1, 35, 40}},

  {act = 'stair', node = N["ST"], height = 4, param2 = 3, coords = {50, 10, 41, 10, 10, 2}},
  {act = 'stair', node = N["ST"], height = 4, param2 = 0, coords = {10, 2, 41, 10, 25, 10}},
  {act = 'stair', node = N["ST"], height = 4, param2 = 3, coords = {20, 10, 41, 10, 55, 2}},
  ...
  {act = 'stair', node = N["ST"], height = 4, param2 = 2, coords = {14, 2, 51, 10, 45, 10}},
  ...
  {act = 'fill', node = N["S0"], coords = {48, 14, 60, 1, 34, 42}},
  {act = 'fill', node = N["S0"], coords = {34, 14, 60, 1, 54, 2}},
  ...
  {act = 'stair', node = N["ST"], height = 4, param2 = 2, coords = {30, 2, 31, 10, 65, 10}},
  ...
  {act = 'stair', node = N["ST"], depth = 2, height = 4, param2 = 3, coords = {69, 10, 21, 10, 39, 2}},
  {act = 'sphere', node = 'air', coords = {10, 20, 11, 20, 2, 20}},
  {act = 'fill', node = N["S0"], coords = {10, 20, 11, 10, 2, 20}},
  {act = 'fill', node = N["SB"], coords = {10, 20, 20, 1, 2, 20}},
  ...
  {act = 'stair', node = N["ST"], height = 4, param2 = 0, coords = {51, 2, 21, 10, 65, 10}},
  {act = 'fill', node = 'air', coords = {39, 2, 21, 3, 65, 14}},
  {act = 'stair', node = N["ST"], height = 4, param2 = 0, coords = {65, 2, 21, 10, 60, 10}},

  {act = 'fill', node = N["ST"], param2 = 0, coords = {51, 2, 20, 1, 53, 1}},

  {act = 'fill', node = 'air', coords = {5, 4, 26, 3, 5, 6}},
  {act = 'fill', node = 'air', coords = {45, 12, 31, 3, 11, 2}},
  {act = 'stair', node = N["ST"], height = 5, param2 = 1, coords = {40, 5, 26, 5, 11, 2}},
  {act = 'fill', node = 'air', coords = {5, 35, 26, 3, 11, 2}},
  {act = 'fill', node = N["S0"], coords = {9, 22, 25, 1, 11, 2}},
  ...
  {act = 'fill', node = N["DR"], param2 = 1, coords = {73, 1, 21, 1, 48, 1}},
  ...
  {act = 'fill', node = 'air', floor = N["SB"], coords = {1, 14, 21, 4, 25, 50}},
  ...
  {act = 'fill', node = N["SB"], coords = {5, 5, 21, 1, 30, 40}},
  {act = 'fill', node = N["WS"], coords = {6, 3, 21, 1, 31, 38}},
  {act = 'stair', node = N["ST"], height = 4, param2 = 2, coords = {70, 2, 31, 10, 60, 10}},
}
...
for _, y in pairs({1, 7, 13, 22, 28, 34, 40, 46, 52}) do
  ...
  table.insert(p, {act = 'fill', node = N["DL"], param2 = 3, coords = {70, 1, 21, 1, y + 2, 1}})
end
...
for _, y in pairs({1, 7, 13, 22, 28}) do
  ...
  table.insert(p, {act = 'fill', node = N["DR"], param2 = 1, coords = {73, 1, 21, 1, y + 2, 1}})
end
...
for _, y in pairs({24, 30, 36, 42, 48, 59, 65, 71}) do
  ...
  table.insert(p, {act = 'fill', node = N["DR"], param2 = 1, coords = {21, 1, 21, 1, y + 2, 1}})
end
