...
--[[
	natural_slopes.register_slope("lib_ecology:tree_conifers_leaves", {
		...
		sounds = gal.node_sound_dirt_defaults({footstep = {['name'] = "node_sound_leaves_defaults", ['gain'] = 0.25},})
		},
		10
	)
...
--REGISTERED BELOW
--	natural_slopes.register_slope("gal:dirt_compacted", {
--		groups = {crumbly = 3, falling_node = 1, sand = 1},
...
--		1
--	)
--	natural_slopes.register_slope("gal:dirt_dried", {
--		groups = {crumbly = 3, falling_node = 1, sand = 1},
...
-- natural_slopes.register_slope("gal:dirt_with_dry_grass", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_with_brown_grass", {
	-- description = "Dirt with Brown Grass slope",
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_permafrost", {
	-- groups = {crumbly = 3, falling_node = 1, sand = 1},
...
-- natural_slopes.register_slope("gal:dirt_clayey_with_grass_hot_temperate_lowland", {
	-- description = "Dirt with Grass (hot_temperate_lowland) Slope",
	-- tiles = {top = ""..GRASS_SEMIHUMID_TEXTURE_TOP.."^[colorize:"..GRASS_TEMPERATE_PALETTE_4.."",
		-- bottom = "lib_materials_dirt_clayey.png",
		-- front = ""..GRASS_SEMIHUMID_TEXTURE_TOP.."^[colorize:"..GRASS_TEMPERATE_PALETTE_4.."",
		-- side = {name = "lib_materials_dirt_clayey.png^("..GRASS_SEMIHUMID_TEXTURE_SIDE.."^[colorize:"..GRASS_TEMPERATE_PALETTE_4..")",
			-- tileable_vertical = false}},
	-- groups = {crumbly = 3, soil = 1},
	-- sounds = gal.node_sound_dirt_defaults({footstep = {name = "default_grass_footstep", gain = 0.4},})
	-- },
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_clayey_with_grass_hot_semiarid_lowland", {
	-- description = "Dirt with Grass (hot_semiarid_lowland) Slope",
	-- tiles = {top = ""..GRASS_SEMIHUMID_TEXTURE_TOP.."^[colorize:"..GRASS_SEMIARID_PALETTE_4.."",
		-- bottom = "lib_materials_dirt_clayey.png",
		-- front = ""..GRASS_SEMIHUMID_TEXTURE_TOP.."^[colorize:"..GRASS_SEMIARID_PALETTE_4.."",
		-- side = {name = "lib_materials_dirt_clayey.png^("..GRASS_SEMIHUMID_TEXTURE_SIDE.."^[colorize:"..GRASS_SEMIARID_PALETTE_4..")",
			-- tileable_vertical = false}},
	-- groups = {crumbly = 3, soil = 1},
	-- sounds = gal.node_sound_dirt_defaults({footstep = {name = "default_grass_footstep", gain = 0.4},})
	-- },
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_sandy_with_grass_temperate_temperate_coastal", {
	-- description = "Dirt with Grass (temperate_temperate_coastal) Slope",
	-- tiles = {top = ""..GRASS_HUMID_TEXTURE_TOP.."^[colorize:"..GRASS_TEMPERATE_PALETTE_2.."",
		-- bottom = "lib_materials_dirt_sandy.png",
		-- front = ""..GRASS_HUMID_TEXTURE_TOP.."^[colorize:"..GRASS_TEMPERATE_PALETTE_2.."",
		-- side = {name = "lib_materials_dirt_sandy.png^("..GRASS_HUMID_TEXTURE_SIDE.."^[colorize:"..GRASS_TEMPERATE_PALETTE_2..")",
			-- tileable_vertical = false}},
	-- groups = {crumbly = 3, soil = 1},
	-- sounds = gal.node_sound_dirt_defaults({footstep = {name = "default_grass_footstep", gain = 0.4},})
	-- },
...
-- natural_slopes.register_slope("gal:dirt_black", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_black_with_snow", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_black_with_coniferous_litter", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_black_with_rainforest_litter", {
...
-- natural_slopes.register_slope("gal:dirt_brown", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_brown_with_snow", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_brown_with_coniferous_litter", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_brown_with_rainforest_litter", {
...
-- natural_slopes.register_slope("gal:dirt_clay_red", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_clay_red_with_snow", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_clay_red_with_coniferous_litter", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_clay_red_with_rainforest_litter", {
...
-- natural_slopes.register_slope("gal:dirt_clayey", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_clayey_with_snow", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_clayey_with_coniferous_litter", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_clayey_with_rainforest_litter", {
...
-- natural_slopes.register_slope("gal:dirt_sandy", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_sandy_with_snow", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_sandy_with_coniferous_litter", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_sandy_with_rainforest_litter", {
...
-- natural_slopes.register_slope("gal:dirt_silty", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_silty_with_snow", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_silty_with_coniferous_litter", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_silty_with_rainforest_litter", {
...
-- natural_slopes.register_slope("gal:dirt_silt_01", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_silt_01_with_snow", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_silt_01_with_coniferous_litter", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_silt_01_with_rainforest_litter", {
...
-- natural_slopes.register_slope("gal:dirt_silt_02", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_silt_02_with_snow", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_silt_02_with_coniferous_litter", {
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_silt_02_with_rainforest_litter", {
...
-- natural_slopes.register_slope("gal:dirt_coarse", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_dark", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_dry", {
	-- groups = {crumbly = 3},
	...
	-- 1
-- )
-- natural_slopes.register_slope("gal:dirt_mud_01", {
	-- groups = {crumbly = 3},
