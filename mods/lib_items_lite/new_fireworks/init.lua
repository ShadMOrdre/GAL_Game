...
local variant_list = {
	...
	{colour = "red", figure = "custom", form = "love", desc = "Red"},
	{colour = "blue_white_red", figure = "ball_default_love", form = "", desc = "blue_white_love",
					rdt = {
...
--								 {color = "red", figure = "custom", form = "love"},
	...
	{colour = "green_yellow_red", figure = "ball_default_love", form = "", desc = "green_yellow_love",
					rdt = {
