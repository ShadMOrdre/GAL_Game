...
-- Updates by Beerholder and reupload to Git
-- as I could not find the one version with
-- the painting API and in order to make it
-- work with MT 0.5.0
...
minetest.register_node("painting:easel", {
	...
	on_punch = function(pos, node, player)
		...
		local itemstack = ItemStack(wielded)
