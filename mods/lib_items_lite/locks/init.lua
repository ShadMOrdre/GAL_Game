...
if gal.gui.gui_bg then 
	locks.uniform_background = locks.uniform_background..gal.gui.gui_bg;
end

if gal.gui.gui_bg_img then
	locks.uniform_background = locks.uniform_background..gal.gui.gui_bg_img;
end

if gal.gui.gui_slots then
	locks.uniform_background = locks.uniform_background..gal.gui.gui_slots;
end
