...
if gal.gui.gui_bg then 
	cannons.formspec = cannons.formspec..gal.gui.gui_bg;
end

if gal.gui.gui_bg_img then 
	cannons.formspec = cannons.formspec..gal.gui.gui_bg_img;
end

if gal.gui.gui_slots then 
	cannons.formspec = cannons.formspec..gal.gui.gui_slots;
end
...
if gal.gui.gui_bg then 
	cannons.disabled_formspec = cannons.disabled_formspec..gal.gui.gui_bg;
end

if gal.gui.gui_bg_img then 
	cannons.disabled_formspec = cannons.disabled_formspec..gal.gui.gui_bg_img;
end

if gal.gui.gui_slots then 
	cannons.disabled_formspec = cannons.disabled_formspec..gal.gui.gui_slots;
end
...
cannons.register_muni("gal:fruit_apple",apple)