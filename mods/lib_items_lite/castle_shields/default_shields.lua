...
castle_shields.register_shield("shield_4", S("Mounted Shield"), "white", "red", "cross")
castle_shields.register_shield("shield_5", S("Mounted Shield"), "black", "grey", "cross")
castle_shields.register_shield("shield_6", S("Mounted Shield"), "dark_grey", "blue", "chevron")
castle_shields.register_shield("shield_7", S("Mounted Shield"), "grey", "red", "chevron")
