...
gal.player.api.register_model("motorbike_biker.b3d", {
	animation_speed = 30,
...
local function force_detach(player)
	...
	if attached_to then
		...
		if entity.info then
			gal.player.api.set_model(player, entity.info.model)
		end
	end
end
...
function biker.attach(entity, player, is_passenger)
	...
	entity.info = {}
	entity.info.model = gal.player.api.get_animation(player).model
	...
	minetest.after(0.2, function()
		gal.player.api.set_model(player, "motorbike_biker.b3d")
	end)
