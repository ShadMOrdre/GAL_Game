...
--Wattle Door
	...
	--gal.lib.shapes.register_door_node("earthbuild:wattle", "door_centered_with_window")

	--gal.lib.shapes.register_door_node("earthbuild:wattle", "door_centered_with_window_right")
...
--Wattle Trapdoor
	...
	--gal.lib.shapes.register_door_node("earthbuild:wattle", "trapdoor_with_window")
