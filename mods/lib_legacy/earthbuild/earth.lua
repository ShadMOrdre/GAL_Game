...
--gal.lib.shapes.register_basic_set("earthbuild:rammed_earth")
--gal.lib.shapes.register_basic_set("earthbuild:cob")
--gal.lib.shapes.register_basic_set("earthbuild:mud_brick")
--gal.lib.shapes.register_basic_set("earthbuild:turf")
