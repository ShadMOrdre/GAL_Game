...
if minetest.get_modpath("intllib") then
	...
	cottages.S, cottages.NS = dofile(minetest.get_modpath("cottages").."/intllib.lua")
end
...
if( not( minetest.get_modpath("default"))) then
	...
	cottages.sounds.wood   = gal.node_sound_wood_defaults()
	cottages.sounds.dirt   = gal.node_sound_dirt_defaults()
	cottages.sounds.stone  = gal.node_sound_stone_defaults()
	cottages.sounds.leaves = gal.node_sound_leaves_defaults()
else
