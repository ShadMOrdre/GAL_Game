...
function xpanes.node_sound_defaults(table)
	table = table or {}
...
function xpanes.node_sound_glass_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
	...
	xpanes.node_sound_defaults(table)
	return table
end

function xpanes.node_sound_metal_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
xpanes.register_pane("pane", {
	...
	sounds = xpanes.node_sound_glass_defaults(),
...
xpanes.register_pane("bar", {
	...
	groups = {cracky=2},
	sounds = xpanes.node_sound_metal_defaults(),
	recipe = {
