xbg = gal.gui.gui_bg..gal.gui.gui_bg_img..gal.gui.gui_slots
...
function lib_tools.register(name, def)
	...
	def.sounds = def.sounds or lib_tools.node_sound_defaults()
