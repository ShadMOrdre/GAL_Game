...
if lib_materials.node_sound_metal_defaults ~= nil then
	metal_sounds = lib_materials.node_sound_metal_defaults()
else
	metal_sounds = lib_materials.node_sound_stone_defaults()
end
