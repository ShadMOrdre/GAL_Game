...
--Air, Lava, and Water constants used throughout schematics
		...
		local P0 = T["P0m00"] or {name = "gal:grass_3", param2 = 0, prob = 254}
		local P1 = T["P1m01"] or {name = "gal:item_seed_cotton", param2 = 1, prob = 254}
		local P2 = T["P2m00"] or {name = "gal:plant_cotton_3", param2 = 0, prob = 254}
