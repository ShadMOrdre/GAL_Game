...
local C0 = {name = "gal:dirt_with_stone_cobble", param2 = 0, prob = 254}
...
function lib_towns.build_schematic(pos, building, sub, replace_wall, name, rot, offset, town_name)
	...
	--schem_lua = schem_lua:gsub("gal:dirt_with_grass", balcony_material)
	--schem_lua = schem_lua:gsub("gal:dirt", balcony_material)
	...
	-- format schematic string
	--local schematic = loadstring(schem_lua)()
	--local schematic = loadstring(tostring(building):gsub("gal:dirt_with_grass", balcony_material))()
	...
	--minetest.after(1, function() --increase waiting time, if "block not found" in debug.txt
		...
		--["gal:dirt"] = "gal:dirt_with_stone", 
		minetest.place_schematic(temp_pos, schematic, rotation, {["gal:dirt_with_grass"] = balcony_material, ["default:dirt_with_grass"] = balcony_material}, "place_center_x, place_center_z", true)
					...
					for l = 1,r_length do
						...
						if t_skip ~= g_skip then
							...
							if surface_point then
								...
								minetest.swap_node(surface_point,{name="gal:stone_cobble"})				--name=lib_towns.towns[town_type].road

								--minetest.swap_node(t_x_n,{name="gal:stone_cobble"})				--name=lib_towns.towns[town_type].road
								--minetest.swap_node(t_x_c,{name="gal:stone_cobble"})				--name=lib_towns.towns[town_type].road
								--minetest.swap_node(t_x_p,{name="gal:stone_cobble"})				--name=lib_towns.towns[town_type].road
								--minetest.swap_node(t_z_n,{name="gal:stone_cobble"})				--name=lib_towns.towns[town_type].road
								--minetest.swap_node(t_z_c,{name="gal:stone_cobble"})				--name=lib_towns.towns[town_type].road
								--minetest.swap_node(t_z_p,{name="gal:stone_cobble"})				--name=lib_towns.towns[town_type].road

								--minetest.bulk_set_node({t_x_n,t_x_c}, {name="gal:stone_cobble"})
					...
					for l = 1,r_length do
						...
						if t_skip ~= g_skip then
							...
							if surface_point then
								...
								--minetest.bulk_set_node({t_z_n,t_z_c}, {name="gal:stone_cobble"})
