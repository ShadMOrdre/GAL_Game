...
--[[
	local dmat0 = NS["S0"] or "gal:stone"
	--local dmat0 = "gal:stone"
	local dmat1 = NS["S1"] or "gal:stone_desert"
	--local dmat1 = "gal:stone_desert"
	local dmat2 = NS["S2"] or "gal:stone_sandstone"
	local dmat3 = NS["S3"] or "gal:stone_sandstone_desert"
	local dmat4 = NS["S4"] or "gal:stone_sandstone_silver"
	local dmat5 = NS["S5"] or "gal:stone_obsidian"
...
--[[
	local default_materials = {
		...
		"gal:stone_desert",
		"gal:stone_sandstone",
		"gal:stone_sandstone_desert",
		"gal:stone_sandstone_silver",
		"gal:stone_obsidian",
	}
--]]
	...
	local dmat4 = NS["S4"] or "gal:stone_sandstone_silver"
	local dmat5 = NS["S5"] or "gal:stone_obsidian"
	local dmat6 = NS["S6"] or "gal:stone_stucco"
	local dmat7 = NS["S7"] or "gal:dirt_clay"
	local dmat8 = NS["S8"] or "gal:dirt_loam"
	local dmat9 = NS["S9"] or "gal:dirt_compacted"
...
--]]
	...
	D["G0"] = "gal:glass"					--Glass

	D["W0"] = "gal:tree_default_wood"			--Wood
	D["T0"] = "gal:tree_default_trunk"			--Tree Trunk
	D["L0"] = "gal:tree_default_leaves"			--Leaves
	D["P0"] = "gal:grass_3"					--Plant
	D["F0"] = "gal:fruit_apple"
	D["I0"] = "gal:plant_vine_01"
	D["B0"] = "gal:mushroom_cap_red_spotted"
	D["H0"] = "gal:mushroom_01_trunk"

	D["W1"] = "gal:tree_jungle_wood"			--Wood
	D["T1"] = "gal:tree_jungle_trunk"			--Tree Trunk
	D["L1"] = "gal:tree_jungle_leaves"			--Leaves
	D["P1"] = "gal:grass_jungle_3"					--Plant

	D["W2"] = "gal:tree_pine_wood"			--Wood
	D["T2"] = "gal:tree_pine_trunk"			--Tree Trunk
	D["L2"] = "gal:tree_pine_leaves"			--Leaves
	...
	T["wwwww"] = {param2 = 0, name = "gal:liquid_water_source", prob = 254}
	T["wwfww"] = {param2 = 0, name = "gal:liquid_water_flowing", prob = 254}
	T["rrrrr"] = {param2 = 0, name = "gal:liquid_water_river_source", prob = 254}
	T["rrfrr"] = {param2 = 0, name = "gal:liquid_water_river_flowing", prob = 254}
	T["lllll"] = {param2 = 0, name = "gal:liquid_lava_source", prob = 254}
	T["llfll"] = {param2 = 0, name = "gal:liquid_lava_flowing", prob = 254}

	T["ddddd"] = {param2 = 0, name = "gal:dirt", prob = 254}			--ddddd = Dirt
	T["ggggg"] = {param2 = 0, name = "gal:dirt_with_grass", prob = 254}		--ggggg = Dirt with Grass
	T["swsws"] = {param2 = 0, name = "gal:dirt_with_soil_wet", prob = 254}		--ggggg = Dirt with Grass

	T["sssss"] = {param2 = 0, name = "gal:sand", prob = 254}			--sssss = sand
	T["ccccc"] = {param2 = 0, name = "gal:", prob = 254}				--ccccc = clay
	T["qqqqq"] = {param2 = 0, name = "gal:", prob = 254}				--qqqqq = quicksand
	T["qqfqq"] = {param2 = 0, name = "gal:", prob = 254}				--qqfqq = quicksand flowing
	...
	T["Dr0N0"] = {param2 = 0, name = "gal:tree_default_wood_door_centered_300_height_150_width_right", prob = 254}					--Dr# = Door Right
	T["Dr0E0"] = {param2 = 1, name = "gal:tree_default_wood_door_centered_300_height_150_width_right", prob = 254}					--Dr# = Door Right
	T["Dr0S0"] = {param2 = 2, name = "gal:tree_default_wood_door_centered_300_height_150_width_right", prob = 254}					--Dr# = Door Right
	T["Dr0W0"] = {param2 = 3, name = "gal:tree_default_wood_door_centered_300_height_150_width_right", prob = 254}					--Dr# = Door Right
	T["Dl0N0"] = {param2 = 0, name = "gal:tree_default_wood_door_centered_300_height_150_width", prob = 254}					--Dl# = Door Left
	T["Dl0E0"] = {param2 = 1, name = "gal:tree_default_wood_door_centered_300_height_150_width", prob = 254}					--Dl# = Door Left
	T["Dl0S0"] = {param2 = 2, name = "gal:tree_default_wood_door_centered_300_height_150_width", prob = 254}					--Dl# = Door Left
	T["Dl0W0"] = {param2 = 3, name = "gal:tree_default_wood_door_centered_300_height_150_width", prob = 254}					--Dl# = Door Left
	...
	T["Ch0N0"] = {param2 = 0, name = "gal:tree_default_wood_chair_basic_01", prob = 254}					--Ch# = Chair
	T["Ch0E0"] = {param2 = 1, name = "gal:tree_default_wood_chair_basic_01", prob = 254}					--Ch# = Chair
	T["Ch0S0"] = {param2 = 2, name = "gal:tree_default_wood_chair_basic_01", prob = 254}					--Ch# = Chair
	T["Ch0W0"] = {param2 = 3, name = "gal:tree_default_wood_chair_basic_01", prob = 254}					--Ch# = Chair
	...
	T["Ta1N0"] = {param2 = 0, name = "gal:tree_default_wood_table_basic_01", prob = 254}
	T["Ta1E0"] = {param2 = 1, name = "gal:tree_default_wood_table_basic_01", prob = 254}
	T["Ta1S0"] = {param2 = 2, name = "gal:tree_default_wood_table_basic_01", prob = 254}
	T["Ta1W0"] = {param2 = 3, name = "gal:tree_default_wood_table_basic_01", prob = 254}

	--SHOULD BE Ca.  Change Cauldron to Cu
	T["Ta2N0"] = {param2 = 0, name = "gal:tree_default_wood_cabinet_basic_01", prob = 254}
	T["Ta2E0"] = {param2 = 1, name = "gal:tree_default_wood_cabinet_basic_01", prob = 254}
	T["Ta2S0"] = {param2 = 2, name = "gal:tree_default_wood_cabinet_basic_01", prob = 254}
	T["Ta2W0"] = {param2 = 3, name = "gal:tree_default_wood_cabinet_basic_01", prob = 254}

	T["Cr0N0"] = {param2 = 0, name = "gal:tree_default_wood_sofa_basic_01_right", prob = 254}					--Cr# = Sofa / Couch right side
	T["Cr0E0"] = {param2 = 1, name = "gal:tree_default_wood_sofa_basic_01_right", prob = 254}					--Cr# = Sofa / Couch right side
	T["Cr0S0"] = {param2 = 2, name = "gal:tree_default_wood_sofa_basic_01_right", prob = 254}					--Cr# = Sofa / Couch right side
	T["Cr0W0"] = {param2 = 3, name = "gal:tree_default_wood_sofa_basic_01_right", prob = 254}					--Cr# = Sofa / Couch right side
	T["Cc0N0"] = {param2 = 0, name = "gal:tree_default_wood_sofa_basic_01_section", prob = 254}					--Cc# = Sofa center
	T["Cc0E0"] = {param2 = 1, name = "gal:tree_default_wood_sofa_basic_01_section", prob = 254}					--Cc# = Sofa center
	T["Cc0S0"] = {param2 = 2, name = "gal:tree_default_wood_sofa_basic_01_section", prob = 254}					--Cc# = Sofa center
	T["Cc0W0"] = {param2 = 3, name = "gal:tree_default_wood_sofa_basic_01_section", prob = 254}					--Cc# = Sofa center
	T["Cn0N0"] = {param2 = 0, name = "gal:tree_default_wood_sofa_basic_01_corner", prob = 254}					--Cc# = Sofa corner
	T["Cn0E0"] = {param2 = 1, name = "gal:tree_default_wood_sofa_basic_01_corner", prob = 254}					--Cc# = Sofa corner
	T["Cn0S0"] = {param2 = 2, name = "gal:tree_default_wood_sofa_basic_01_corner", prob = 254}					--Cc# = Sofa corner
	T["Cn0W0"] = {param2 = 3, name = "gal:tree_default_wood_sofa_basic_01_corner", prob = 254}					--Cc# = Sofa corner
	T["Cl0N0"] = {param2 = 0, name = "gal:tree_default_wood_sofa_basic_01_left", prob = 254}					--Cl# = Sofa left side
	T["Cl0E0"] = {param2 = 1, name = "gal:tree_default_wood_sofa_basic_01_left", prob = 254}					--Cl# = Sofa left side
	T["Cl0S0"] = {param2 = 2, name = "gal:tree_default_wood_sofa_basic_01_left", prob = 254}					--Cl# = Sofa left side
	T["Cl0W0"] = {param2 = 3, name = "gal:tree_default_wood_sofa_basic_01_left", prob = 254}					--Cl# = Sofa left side

	--T["Bd0N0"] = {param2 = 0, name = "gal:tree_default_wood_bed_simple", prob = 254}					--Bd# = Bed 0-9
	...
	T["BlyS0"] = {param2 = 0, name = "gal:item_seed_barley", prob = 254}					--Barley
	T["Bly10"] = {param2 = 0, name = "gal:plant_barley_1", prob = 254}					--Barley
	T["Bly20"] = {param2 = 0, name = "gal:plant_barley_2", prob = 254}					--
	T["Bly30"] = {param2 = 0, name = "gal:plant_barley_3", prob = 254}					--
	T["Bly40"] = {param2 = 0, name = "gal:plant_barley_4", prob = 254}					--
	T["Bly50"] = {param2 = 0, name = "gal:plant_barley_5", prob = 254}					--
	T["Crt10"] = {param2 = 1, name = "gal:plant_carrot_1", prob = 254}					--Cotton Seed
	T["Crt20"] = {param2 = 1, name = "gal:plant_carrot_2", prob = 254}					--Cotton Seed
	T["Crt30"] = {param2 = 1, name = "gal:plant_carrot_3", prob = 254}					--Cotton Seed
	T["Crt40"] = {param2 = 1, name = "gal:plant_carrot_4", prob = 254}					--Cotton Seed
	T["Crt50"] = {param2 = 1, name = "gal:plant_carrot_5", prob = 254}					--Cotton Seed
	T["Crt60"] = {param2 = 1, name = "gal:plant_carrot_6", prob = 254}					--Cotton Seed
	T["Crt70"] = {param2 = 1, name = "gal:plant_carrot_7", prob = 254}					--Cotton Seed
	T["Crt80"] = {param2 = 1, name = "gal:plant_carrot_8", prob = 254}					--Cotton Seed
	T["Chl10"] = {param2 = 1, name = "gal:plant_chili_1", prob = 254}					--Cotton Seed
	T["Chl20"] = {param2 = 1, name = "gal:plant_chili_2", prob = 254}					--Cotton Seed
	T["Chl30"] = {param2 = 1, name = "gal:plant_chili_3", prob = 254}					--Cotton Seed
	T["Chl40"] = {param2 = 1, name = "gal:plant_chili_4", prob = 254}					--Cotton Seed
	T["Chl50"] = {param2 = 1, name = "gal:plant_chili_5", prob = 254}					--Cotton Seed
	T["Chl60"] = {param2 = 1, name = "gal:plant_chili_6", prob = 254}					--Cotton Seed
	T["Chl70"] = {param2 = 1, name = "gal:plant_chili_7", prob = 254}					--Cotton Seed
	T["Chl80"] = {param2 = 1, name = "gal:plant_chili_8", prob = 254}					--Cotton Seed
	T["CfeB0"] = {param2 = 1, name = "gal:item_beans_coffee", prob = 254}					--Cotton Seed
	T["Cfe10"] = {param2 = 1, name = "gal:plant_coffee_1", prob = 254}					--Cotton Seed
	T["Cfe20"] = {param2 = 1, name = "gal:plant_coffee_2", prob = 254}					--Cotton Seed
	T["Cfe30"] = {param2 = 1, name = "gal:plant_coffee_3", prob = 254}					--Cotton Seed
	T["Cfe40"] = {param2 = 1, name = "gal:plant_coffee_4", prob = 254}					--Cotton Seed
	T["Cfe50"] = {param2 = 1, name = "gal:plant_coffee_5", prob = 254}					--Cotton Seed
	T["Crn10"] = {param2 = 0, name = "gal:plant_corn_1", prob = 254}					--Corn
	T["Crn20"] = {param2 = 0, name = "gal:plant_corn_2", prob = 254}					--
	T["Crn30"] = {param2 = 0, name = "gal:plant_corn_3", prob = 254}					--
	T["Crn40"] = {param2 = 0, name = "gal:plant_corn_4", prob = 254}					--
	T["Crn50"] = {param2 = 0, name = "gal:plant_corn_5", prob = 254}					--
	T["Crn60"] = {param2 = 0, name = "gal:plant_corn_6", prob = 254}					--Corn
	T["Crn70"] = {param2 = 0, name = "gal:plant_corn_7", prob = 254}					--Corn
	T["Crn80"] = {param2 = 0, name = "gal:plant_corn_8", prob = 254}					--Corn
	T["CtnS0"] = {param2 = 1, name = "gal:item_seed_cotton", prob = 254}					--Cotton Seed
	T["Ctn10"] = {param2 = 0, name = "gal:plant_cotton_1", prob = 254}					--Cotton
	T["Ctn20"] = {param2 = 0, name = "gal:plant_cotton_2", prob = 254}					--
	T["Ctn30"] = {param2 = 0, name = "gal:plant_cotton_3", prob = 254}					--
	T["Ctn40"] = {param2 = 0, name = "gal:plant_cotton_4", prob = 254}					--
	T["Ctn50"] = {param2 = 0, name = "gal:plant_cotton_5", prob = 254}					--Cotton
	T["Ctn60"] = {param2 = 0, name = "gal:plant_cotton_6", prob = 254}					--Cotton
	T["Ctn70"] = {param2 = 0, name = "gal:plant_cotton_7", prob = 254}					--Cotton
	T["Ctn80"] = {param2 = 0, name = "gal:plant_cotton_8", prob = 254}					--Cotton
	T["Pot10"] = {param2 = 0, name = "gal:plant_potato_1", prob = 254}					--Potato
	T["Pot20"] = {param2 = 0, name = "gal:plant_potato_2", prob = 254}					--Potato
	T["Pot30"] = {param2 = 0, name = "gal:plant_potato_3", prob = 254}					--Potato
	T["Pot40"] = {param2 = 0, name = "gal:plant_potato_4", prob = 254}					--Potato
	T["WhtS0"] = {param2 = 0, name = "gal:item_seed_wheat", prob = 254}					--Wheat
	T["Wht10"] = {param2 = 0, name = "gal:plant_wheat_1", prob = 254}					--Wheat
	T["Wht20"] = {param2 = 0, name = "gal:plant_wheat_2", prob = 254}					--Wheat
	T["Wht30"] = {param2 = 0, name = "gal:plant_wheat_3", prob = 254}					--Wheat
	T["Wht40"] = {param2 = 0, name = "gal:plant_wheat_4", prob = 254}					--Wheat
	T["Wht50"] = {param2 = 0, name = "gal:plant_wheat_5", prob = 254}					--Wheat
	T["Wht60"] = {param2 = 0, name = "gal:plant_wheat_6", prob = 254}					--Wheat
	T["Wht70"] = {param2 = 0, name = "gal:plant_wheat_7", prob = 254}					--Wheat
	T["Wht80"] = {param2 = 0, name = "gal:plant_wheat_8", prob = 254}					--Wheat

	T["MtSN0"] = {param2 = 0, name = "gal:metal_steel_block", prob = 254}
