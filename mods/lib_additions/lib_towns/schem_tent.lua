...
local D0 = {name = "gal:tree_default_wood_door_centered_with_window_right", param2 = 0, prob = 254}
local D5 = {name = "gal:tree_default_wood_door_centered_with_window", param2 = 0, prob = 254}
...
local I5 = {name = "gal:tree_default_sapling", param2 = 0, prob = 254}
