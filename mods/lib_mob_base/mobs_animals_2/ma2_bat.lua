...
-- local variables
	...
	local l_spawnnear	= {"gal:stone"}
	local l_spawnchance	= 30000

	mobs:register_mob("mobs_animals_2:bat", {
		type = "animal",
		damage = 1,
		reach = 1,
	...
	--mobs:spawn_specific("mobs_animals_2:bat", {"air"}, l_spawnnear, 0, 6, 30, l_spawnchance, 2, -100, 11000)
