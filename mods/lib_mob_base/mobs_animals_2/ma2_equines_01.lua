...
mobs:register_mob("mobs_animals_2:horse_brown2", merge(hrs, horse))
...
mobs:register_mob("mobs_animals_2:horse_white2", merge(peg, horse))
...
mobs:register_mob("mobs_animals_2:horse_arabian2", merge(ara, horse))
