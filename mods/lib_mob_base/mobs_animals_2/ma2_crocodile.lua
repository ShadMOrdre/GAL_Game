...
-- no float
	--if ENABLE_WALKERS then
		mobs:register_mob("mobs_animals_2:crocodile", {
			type = "monster",
		...
		-- mobs:spawn_specific("mobs_animals_2:crocodile",
		...
		-- mobs:register_egg("mobs_animals_2:crocodile", "Crocodile", l_egg_texture, 1)
	--end

-- float
	--if ENABLE_FLOATERS then
		mobs:register_mob("mobs_animals_2:crocodile_float", {
			type = "monster",
			attack_type = "dogfight",
			damage = 8,
			reach = 2,
		...
		--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
		-- mobs:spawn_specific("mobs_animals_2:crocodile_float",
		...
		-- mobs:register_egg("mobs_animals_2:crocodile_float", "Crocodile (floater)", l_egg_texture, 1)
	--end

-- swim
	--if ENABLE_SWIMMERS then
		mobs:register_mob("mobs_animals_2:crocodile_swim", {
			type = "monster",
			attack_type = "dogfight",
			damage = 8,
			reach = 1,
		...
		--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
		-- mobs:spawn_specific("mobs_animals_2:crocodile_swim",
			-- {"default:water_flowing","default:water_source"},
			-- {"default:sand","default:dirt","group:seaplants"},
			-- -1, 18, 30, l_spawn_chance, 1, -8, 31000)
		-- mobs:register_egg("mobs_animals_2:crocodile_swim", "Crocodile (swimmer)", l_egg_texture, 1)
	--end
