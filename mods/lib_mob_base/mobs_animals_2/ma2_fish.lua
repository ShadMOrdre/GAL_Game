...
-- local variables
	local l_spawn_in		= {"gal:liquid_water_source", "gal:liquid_water_flowing", "gal:liquid_water_river_source", "gal:liquid_water_river_flowing"}
	local l_spawn_near		= {"gal:sand","gal:dirt","group:seaplants","group:seacoral"}
...
-- Clownfish
	mobs:register_mob("mobs_animals_2:clownfish", {
		type = "animal",
		passive = true,
		hp_min = 1,
		hp_max = 4,
	...
	-- mobs:spawn_specific("mobs_animals_2:clownfish", l_spawn_in, l_spawn_near, 5, 20, 30, l_spawn_chance, 1, -31000, l_water_level)
	-- mobs:register_egg("mobs_animals_2:clownfish", "Clownfish", "animal_clownfish_clownfish_item.png", 0)

-- Tropical fish
	mobs:register_mob("mobs_animals_2:tropical", {
		type = "animal",
		passive = true,
		hp_min = 1,
		hp_max = 4,
	...
	--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
	-- mobs:spawn_specific("mobs_animals_2:tropical", l_spawn_in, l_spawn_near, 5, 20, 30, l_spawn_chance, 1, -31000, l_water_level)
