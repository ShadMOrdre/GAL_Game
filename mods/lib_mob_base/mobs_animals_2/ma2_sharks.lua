...
-- local variables
	...
	local l_spawn_in		= {"gal:liquid_water_flowing","gal:liquid_water_source"}
	local l_spawn_near		= {"gal:liquid_water_flowing","gal:liquid_water_source"}
...
-- large
	--if ENABLE_SHARK_LARGE then
		mobs:register_mob("mobs_animals_2:shark_lg", {
			type = "monster",
		...
		-- mobs:spawn_specific("mobs_animals_2:shark_lg", l_spawn_in, l_spawn_near, -1, 20, 30, l_spawn_chance, 1, -31000, 0)
		-- mobs:register_egg("mobs_animals_2:shark_lg", "Shark (large)", l_egg_texture, 0)
	--end

-- medium
	--if ENABLE_SHARK_MEDIUM then
		mobs:register_mob("mobs_animals_2:shark_md", {
			type = "monster",
			attack_type = "dogfight",
			damage = 8,
			reach = 2,
		...
		--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
		-- mobs:spawn_specific("mobs_animals_2:shark_md", l_spawn_in, l_spawn_near, -1, 20, 30, l_spawn_chance, 1, -31000, 0)
		-- mobs:register_egg("mobs_animals_2:shark_md", "Shark (medium)", l_egg_texture, 0)
	--end

-- small
	--if ENABLE_SHARK_SMALL then
		mobs:register_mob("mobs_animals_2:shark_sm", {
			type = "monster",
			attack_type = "dogfight",
			damage = 6,
			reach = 1,
		...
		--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
		-- mobs:spawn_specific("mobs_animals_2:shark_sm", l_spawn_in, l_spawn_near, -1, 20, 30, l_spawn_chance, 1, -31000, 0)
		-- mobs:register_egg("mobs_animals_2:shark_sm", "Shark (small)", l_egg_texture, 0)
	--end
