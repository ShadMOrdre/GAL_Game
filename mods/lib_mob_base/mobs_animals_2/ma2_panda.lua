...
mobs:register_mob("mobs_animals_2:panda", {
	...
	jump_height = 2,
	replace_rate = 10,
	replace_what = {"gal:tree_bamboo_trunk", "gal:tree_bamboo_leaves", "gal:tree_bamboo_sprout"},
	replace_with = "air",
	follow = {"gal:tree_bamboo_trunk", "gal:tree_bamboo_sprout"},
	view_range = 14,
	animation = {
		speed_normal = 6,
		speed_run = 10,
...
mobs:register_mob("mobs_animals_2:panda1", {
	type = "animal",
	passive = false,
	reach = 1,
	damage = 2,
