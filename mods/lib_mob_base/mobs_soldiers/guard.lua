...
mobs:register_mob("mobs_soldiers:guard", {
	-- animal, monster, npc
	type = "npc",
	passive = true,
	damage = 7,
	...
	drawtype = "front",
	textures = {
		{"mobs_npc.png", "npcf_skin_armor.png", "lib_materials_tool_battleaxe.png"},
	},
	visual_size = {x=1, y=1},
	-- sounds
...
mobs:register_egg("mobs_soldiers:guard", "Guard", "default_steel_block.png", 1)
