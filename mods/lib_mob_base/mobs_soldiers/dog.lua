...
mobs:register_mob("mobs_soldiers:dog_brown", {
	type = "npc",
	passive = true,
	hp_max = 5,
...
mobs:register_egg("mobs_soldiers:dog_brown", "Dog", "wool_brown.png", 1)

mobs:register_mob("mobs_soldiers:dog_black", {
	type = "npc",
	passive = true,
	hp_max = 5,
	collisionbox = {-0.4, -0.01, -0.4, 0.4, 1, 0.4},
...
mobs:register_egg("mobs_soldiers:dog_black", "Dog", "wool_black.png", 1)

mobs:register_mob("mobs_soldiers:dog_grey", {
	type = "npc",
	passive = true,
	hp_max = 5,
	collisionbox = {-0.4, -0.01, -0.4, 0.4, 1, 0.4},
...
mobs:register_egg("mobs_soldiers:dog_grey", "Dog", "wool_grey.png", 1)

mobs:register_mob("mobs_soldiers:dog_white", {
	type = "npc",
	passive = true,
	hp_max = 5,
	collisionbox = {-0.4, -0.01, -0.4, 0.4, 1, 0.4},
...
mobs:register_egg("mobs_soldiers:dog_white", "Dog", "wool_white.png", 1)
