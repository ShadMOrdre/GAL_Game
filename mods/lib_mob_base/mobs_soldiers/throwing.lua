arrows = {
	{"mobs_soldiers:arrow", "mobs_soldiers:arrow_entity"},
	{"mobs_soldiers:arrow_fire", "mobs_soldiers:arrow_fire_entity"},
}
...
minetest.register_tool("mobs_soldiers:bow_wood", {
...
minetest.register_tool("mobs_soldiers:bow_stone", {
...
minetest.register_craft({
	output = 'mobs_soldiers:bow_stone',
	recipe = {
...
minetest.register_tool("mobs_soldiers:bow_steel", {
...
minetest.register_craft({
	output = 'mobs_soldiers:bow_steel',
	recipe = {
