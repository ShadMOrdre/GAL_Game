...
-- Phase 1
a_npc.data.DIALOGUES.female["phase1"] = {
	[1] = {
		text = "Hello there!"
	},
	[2] = {
  ...
  [7] = {
    ...
    responses = {
      [1] = {
        ...
        action_type = "dialogue",
        action = {
          text = "Could you please give me 3 "..a_npc.trade.prices.currency.tier3.name.."?",
          responses = {
            [1] = {
              text = "Yes, ok, here",
              action_type = "function",
              action = function(self, player)
                ...
                local args = {
                  ...
                  pos=nil, 
                  inv_list="main", 
                  item_name=a_npc.trade.prices.currency.tier3.string, 
                  count=3
                }
                a_npc.actions.execute(self, a_npc.actions.cmd.TAKE_ITEM, {
                ...
                -- Set flag
                a_npc.add_flag(self, "received_money_help", true)
                -- Add chat line
                table.insert(self.dialogues.normal, a_npc.data.DIALOGUES.female["phase1"][8])
              end
            },
            [2] = {
              text = "No, I'm sorry",
...
-- Phase 2
a_npc.data.DIALOGUES.female["phase2"] = {
	[1] = {
		text = "Hey buddy!"
	},
	[2] = {
...
-- Phase 3
a_npc.data.DIALOGUES.female["phase3"] = {
	[1] = {
...
-- Phase 4
a_npc.data.DIALOGUES.female["phase4"] = {
	[1] = {
...
-- Phase 5
a_npc.data.DIALOGUES.female["phase5"] = {
	[1] = {
...
-- Phase 6
a_npc.data.DIALOGUES.female["phase6"] = {
	[1] = {
...
-- Phase 1
a_npc.data.DIALOGUES.male["phase1"] = {
	[1] = {
		text = "Hello!"
	},
	[2] = {
...
-- Phase 2
a_npc.data.DIALOGUES.male["phase2"] = {
	[1] = {
		text = "Hey buddy!"
	},
	[2] = {
...
-- Phase 3
a_npc.data.DIALOGUES.male["phase3"] = {
	[1] = {
		text = "Hi there! Great to see you!"
	},
	[2] = {
...
-- Phase 4
a_npc.data.DIALOGUES.male["phase4"] = {
	[1] = {
		text = "I was honestly looking forward to talk to you!"
	},
	[2] = {
...
-- Phase 5
a_npc.data.DIALOGUES.male["phase5"] = {
	[1] = {
		text = "You are the love of my life"
	},
	[2] = {
...
-- Phase 6
a_npc.data.DIALOGUES.male["phase6"] = {
	[1] = {
		text = "You are the best thing that has happened to me!"
	},
	[2] = {
...
a_npc.FAVORITE_ITEMS = {
  female = {},
  male = {}
}
-- Define items by phase
-- Female
a_npc.FAVORITE_ITEMS.female["phase1"] = {
  {item = "default:apple",        
...
a_npc.FAVORITE_ITEMS.female["phase2"] = {
  {item = "farming:cotton",        
...
a_npc.FAVORITE_ITEMS.female["phase3"] = {
  {item = "default:apple",        
   response = "Hey, I really wanted an apple, thank you!",
   hint = "I could really do with an apple..."},
  {item = "farming:bread",
...
a_npc.FAVORITE_ITEMS.female["phase4"] = {
  {item = "default:apple",        
   response = "Hey, I really wanted an apple, thank you!",
   hint = "I could really do with an apple..."},
  {item = "farming:bread",
...
a_npc.FAVORITE_ITEMS.female["phase5"] = {
  {item = "default:apple",        
   response = "Hey, I really wanted an apple, thank you!",
   hint = "I could really do with an apple..."},
  {item = "farming:bread",
...
a_npc.FAVORITE_ITEMS.female["phase6"] = {
  {item = "default:apple",        
   response = "Hey, I really wanted an apple, thank you!",
   hint = "I could really do with an apple..."},
  {item = "farming:bread",
...
-- Male
a_npc.FAVORITE_ITEMS.male["phase1"] = {
   {item = "default:apple",        
   response = "Hey, I really wanted an apple, thank you!",
   hint = "I could really do with an apple..."},
  {item = "farming:bread",
...
a_npc.FAVORITE_ITEMS.male["phase2"] = {
  {item = "farming:cotton",        
   response = "This is going to be very helpful, thank you!",
   hint = "If I just had some cotton lying around..."},
  {item = "wool:white",
...
a_npc.FAVORITE_ITEMS.male["phase3"] = {
  {item = "default:apple",        
   response = "Hey, I really wanted an apple, thank you!",
   hint = "I could really do with an apple..."},
  {item = "farming:bread",
...
a_npc.FAVORITE_ITEMS.male["phase4"] = {
  {item = "default:apple",        
   response = "Hey, I really wanted an apple, thank you!",
   hint = "I could really do with an apple..."},
  {item = "farming:bread",
...
a_npc.FAVORITE_ITEMS.male["phase5"] = {
  {item = "default:apple",        
   response = "Hey, I really wanted an apple, thank you!",
   hint = "I could really do with an apple..."},
  {item = "farming:bread",
...
a_npc.FAVORITE_ITEMS.male["phase6"] = {
  {item = "default:apple",        
   response = "Hey, I really wanted an apple, thank you!",
   hint = "I could really do with an apple..."},
  {item = "farming:bread",
