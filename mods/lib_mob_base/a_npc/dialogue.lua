...
function a_npc.conversation.show_options_dialogue(self, 
																						dialogue,
  ...
  local responses = dialogue.responses
	...
	a_npc.conversation.dialogue_results.options_dialogue[player_name] = {
		npc = self,
		is_married_dialogue = (dialogue.dialogue_type == a_npc.conversation.dialogue_type.married),
		is_casual_trade_dialogue = (dialogue.dialogue_type == a_npc.conversation.dialogue_type.casual_trade),
    is_dedicated_trade_dialogue = (dialogue.dialogue_type == a_npc.conversation.dialogue_type.dedicated_trade),
    is_custom_trade_dialogue = (dialogue.dialogue_type == a_npc.conversation.dialogue_type.custom_trade),
...
function a_npc.conversation.create_custom_trade_options(self, player)
  ...
  dialogue.dialogue_type = a_npc.conversation.dialogue_type.custom_trade
...
function a_npc.conversation.process_dialogue(self, dialogue, player_name)
  ...
  if dialogue.flag then
    ...
    local flag_value = a_npc.get_flag(self, dialogue.flag.name)
