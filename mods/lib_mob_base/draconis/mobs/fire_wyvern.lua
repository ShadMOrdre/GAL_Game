...
mobs:register_arrow("draconis:wyvern_fire_breath", {
	visual = "sprite",
	visual_size = {x = 1, y = 1},
...
-- Fire Wyvern by ElCeejo

mobs:register_mob("draconis:fire_wyvern", {
	type = "monster",
	hp_min = 417,
	hp_max = 417,
	armor = 75,
	...
	drops = {
		{name = "mobs:meat_raw", chance = 1, min = 7, max = 10},
	},
	visual = "mesh",
	visual_size = {x=20, y=20},
	collisionbox = {-1.3, -1.0, -1.3, 1.3, 1.8, 1.3},
	textures = {
		{"draconis_fire_wyvern1.png"},
		{"draconis_fire_wyvern2.png"},
		{"draconis_fire_wyvern3.png"},
		{"draconis_fire_wyvern4.png"},
	},
	child_texture = {
		{"draconis_fire_wyvern1.png"},
		{"draconis_fire_wyvern2.png"},
...
mobs:register_mob("draconis:hatched_fire_wyvern", {
	type = "npc",
	hp_min = 417,
	hp_max = 417,
	armor = 75,
	...
	if self.driver then
		...
		mobs.drive(self, "walk", "stand", true, dtime)
                mobs.fly(self, dtime, 7, true, "draconis:wyvern_fire_breath", "walk", "stand")
...
minetest.register_node("draconis:fire_wyvern_egg", {
        description = "Fire Wyvern Egg",
	tiles = {"draconis_fire_wyvern_nest.png"},
        inventory_image = "draconis_fire_egg.png",
        wield_image = "draconis_fire_egg.png",
	drawtype = "mesh",
	...
	on_timer = function(pos)
		...
		mob = minetest.add_entity(pos, "draconis:hatched_fire_wyvern")
