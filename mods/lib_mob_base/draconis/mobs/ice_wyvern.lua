...
mobs:register_arrow("draconis:wyvern_frost_breath", {
	visual = "sprite",
	visual_size = {x = 1, y = 1},
...
mobs:register_mob("draconis:ice_wyvern", {
	type = "monster",
	hp_min = 394,
	hp_max = 394,
	armor = 75,
...
mobs:register_mob("draconis:hatched_ice_wyvern", {
	type = "npc",
	hp_min = 394,
	hp_max = 394,
	armor = 75,
...
minetest.register_node("draconis:ice_wyvern_egg", {
