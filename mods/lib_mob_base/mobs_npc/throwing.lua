arrows = {
	{"mobs_npc:arrow", "mobs_npc:arrow_entity"},
	{"mobs_npc:arrow_fire", "mobs_npc:arrow_fire_entity"},
}
...
minetest.register_tool("mobs_npc:bow_wood", {
...
minetest.register_tool("mobs_npc:bow_stone", {
...
minetest.register_tool("mobs_npc:bow_steel", {
...
if minetest.setting_get("log_mods") then
	minetest.log("action", "mobs_npc arrows loaded")
end
