...
-- Tyrannosaurus Enemies (Territorial dinosaurs fight other territorial dinosaurs)
local tyrannosaurus_attack = function(self)
	...
	for n = 1, #objs do
		...
		and (type == "player" or type == "monster" or type == "npc" or type == "animal" or type == "spinosaurus" or type == "predatory_dinosaur" or type == "herbivorous_dinosaur") then
...
-- Spinosaurus Enemies (Territorial dinosaurs fight other territorial dinosaurs)
local spinosaurus_attack = function(self)

	if self.type ~= "spinosaurus"
	or self.state == "attack" then
		return
	end
	...
	for n = 1, #objs do
		...
		if specific_attack(self.specific_attack, name)
		and (type == "player" or type == "monster" or type == "npc" or type == "animal" or type == "tyrannosaurus" or type == "predatory_dinosaur" or type == "aquatic") then
...
local monster_attack = function(self)
	...
	if self.type ~= "predatory_dinosaur"
	or self.state == "attack" then
		return
	end
	...
	for n = 1, #objs do
		...
		if specific_attack(self.specific_attack, name)
		and (type == "player" or type == "monster" or type == "npc" or type == "animal" or type == "herbivorous_dinosaur") then
...
minetest.register_entity(name, {
	...
	attacks_animals = def.attacks_animals or false,
