...
mobs:register_mob("mobs_races:ninja", {
	-- animal, monster, npc
	type = "monster",
...
--mobs:register_spawn("mobs_races:ninja", {"default:leaves"}, 20, 0, 15000, 1, 31000)
--mobs:register_egg("mobs_races:ninja", "Ninja", "default_leaves.png", 1)

mobs:register_arrow("mobs_races:shuriken", {
	visual = "sprite",
	visual_size = {x=.5, y=.5},
...
local mobs_shoot_shuriken=function (item, player, pointed_thing)
	...
	local obj=minetest.add_entity({x=playerpos.x,y=playerpos.y+1.5,z=playerpos.z}, "mobs_races:shuriken")
...
-- shuriken item
minetest.register_craftitem("mobs_races:shuriken", {
