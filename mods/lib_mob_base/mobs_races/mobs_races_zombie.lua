...
minetest.register_craftitem("mobs_races:rotten_flesh", {
...
mobs:register_mob("mobs_races:zombie", {
	type = "monster",
	passive = false,
...
mobs:spawn({
	name = "mobs_races:zombie",
	nodes = {"gal:dirt_with_grass"},
	min_light = 0,
	max_light = 7,
	chance = 9000,
