...
mobs:register_mob("mobs_races:dragon3", mobs_races.deepclone(dragondef) )
...
mobs:register_mob("mobs_races:dragon_green", mobs_races.deepclone(dragondef) )
