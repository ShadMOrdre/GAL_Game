local gdragon_base = {
	...
	fly = true,
	drops = {
		{name = "mobs_races:dragon_egg_great", chance = 1, min = 1, max = 1},
	},
	fall_speed = 0,
	stepheight = 10,
	water_damage = 2,
...
mobs:register_mob("mobs_races:dragon_great", mobs_races.deepclone(gdragon_base) )
...
mobs:register_mob("mobs_races:dragon_great_tame", mobs_races.deepclone(gdragon_base) )
