mobs:register_mob("mobs_races:waterdragon", {
	type = "monster",
	passive = false,
	...
	jump = false,
	drops = {
		{name = "mobs_races:dragon_gem_ice", chance = 1, min = 1, max = 1},
		{name = "mobs_races:dragon_gem_fire", chance = 1, min = 1, max = 1},
	},
	water_damage = 0,
	lava_damage = 5,
	light_damage = 0,
	...
	--follow thanks to TenPlus1 and Byakuren
            if not self.hydra then
                ...
                obj = minetest.add_entity({x=pos.x+1, y=pos.y, z=pos.z}, "mobs_races:waterdragon_2")
                ent = obj:get_luaentity()
                ent.following = self.object

                -- add body and make it follow previous body segment
                obj2 = minetest.add_entity({x=pos.x-1, y=pos.y, z=pos.z}, "mobs_races:waterdragon_2")
...
mobs:register_mob("mobs_races:waterdragon_2", {
	type = "monster",
	passive = false,
	attack_type = "shoot",
	dogshoot_switch = 2,
