...
mobs:register_mob("mobs_races:balrog", {
	nametag = "",
	type = "monster",
	hp_min = MIN_HP,
	hp_max = MAX_HP,
...
minetest.register_tool("mobs_races:balrog_whip", {
      ...
      elseif pointed_thing.type == "node" then
         ...
         for y = 10, -10, -1 do
            ...
            and not minetest.is_protected(new_pos, name) then
               minetest.set_node(new_pos, {name = "gal:fire_flame_basic"})
               break
            end
         end
         end
...
mobs:alias_mob("mobs:balrog", "mobs_races:balrog")
