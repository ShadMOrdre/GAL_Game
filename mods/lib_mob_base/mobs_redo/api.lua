...
local node_fire = "gal:fire_basic_flame"
local node_permanent_flame = "gal:fire_permanent_flame"
local node_ice = "gal:ice"
local node_snowblock = "gal:snowblock"
local node_snow = "gal:snow"
mobs.fallback_node = minetest.registered_aliases["mapgen_dirt"] or "gal:dirt"
...
local is_50 = minetest.registered_nodes["gal:dirt_permafrost"]
...
--ShadMOrdre
		----DEFAULT PATHFINDING
		--self.path.way = minetest.find_path(s, p1, 16, jumpheight, dropheight, "Dijkstra")
		----PATHFINDER PATHFINDING
		--self.path.way = pathfinder.find_path(s, p1, self, dtime)
		----TRACKSTAR PATHFINDING
		self.path.way = trackstar.calculate_path(s, p1, true)
...
local tr = minetest.get_modpath("lib_trm")
