...
-- -- )
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = "gal:tree_jungle_leaves",
		sidelen = 80,
		fill_ratio = 0.001,
		biomes = "junglee",
		y_min = 4,
		y_max = 200,
		decoration = "mobs_nssm:web",
		spawn_by = "gal:tree_jungle_trunk",
		num_spawn_by = 4,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = "gal:dirt_dried",
		sidelen = 80,
		fill_ratio = 0.001,
		biomes = "plains",
		y_min = 4,
		y_max = 200,
		decoration = "mobs_nssm:ant_dirt",
		spawn_by = "gal:dirt_dried",
		num_spawn_by = 4,
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
...
minetest.register_node("mobs_nssm:ant_dirt", {
	description = "Ant Dirt",
	tiles = {"ant_dirt.png"},
	groups = {crumbly=3},
})

minetest.register_node("mobs_nssm:web", {
	description = "Web",
	...
	liquidtype = "source",
	liquid_range = 0,
	liquid_alternative_flowing = "mobs_nssm:web",
	liquid_alternative_source = "mobs_nssm:web",
	liquid_viscosity = 20,
...
minetest.register_tool('mobs_nssm:sun_sword', {
	...
	minetest.register_on_punchnode(function(pos, node, puncher, pointed_thing)
		if puncher:get_wielded_item():get_name() == 'mobs_nssm:sun_sword' then
...
minetest.register_tool("mobs_nssm:masticone_fang_sword", {
...
minetest.register_tool("mobs_nssm:night_sword", {
...
minetest.register_node("mobs_nssm:rope", {
	description = "Rope",
	paramtype = "light",
	walkable = false,
	climbable = true,
...
minetest.register_tool("mobs_nssm:stoneater_pick", {
...
minetest.register_tool("mobs_nssm:mantis_sword", {
...
minetest.register_tool("mobs_nssm:ant_sword", {
