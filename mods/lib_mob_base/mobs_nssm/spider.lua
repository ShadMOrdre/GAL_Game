...
mobs:register_mob("mobs_nssm:spider", {
	--docile_by_day = true,
	group_attack = true,
	type = "monster",
	passive = false,
...
-- above ground spawn
mobs:spawn({
	name = "mobs_nssm:spider",
	nodes = {
		"gal:dirt_with_litter_rainforest", "gal:snow",
		"gal:dirt_with_grass_crystal", "gal:dirt_with_grass_cold"
	},
	min_light = 0,
	max_light = 8,
	chance = 7000,
...
mobs:spawn({
	name = "mobs_nssm:spider",
	nodes = {"gal:ore_stone_with_mese", "gal:stone"},
	min_light = 0,
	max_light = 7,
	chance = 7000,
	active_object_count = 1,
...
--mobs:alias_mob("mobs_nssm:spider2", "mobs_nssm:spider") -- compatibility
--mobs:alias_mob("mobs:spider", "mobs_nssm:spider")
