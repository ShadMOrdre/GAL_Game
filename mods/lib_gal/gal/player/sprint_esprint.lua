...
minetest.register_on_joinplayer(function(player)
	...
	gal.player.hud.change_item(player, "sprint", {number = 20})

--	if SPRINT_HUD == "hudbar" then
...
gal.player.sprint_globalstep = function (dtime)
	--Get the gametime
...
--			elseif SPRINT_HUD == "hud" then
				gal.player.hud.change_item(player, "sprint", {number = (playerInfo["stamina"]/SPRINT_STAMINA)*20})
--			else
