...
local homes_file = gal.path_world .. "/homes"
local homepos = {}
...
gal.player.sethome.set = function(name, pos)
...
gal.player.sethome.get = function(name)
	local player = minetest.get_player_by_name(name)
...
gal.player.sethome.go = function(name)
	local pos = gal.player.sethome.get(name)
	local player = minetest.get_player_by_name(name)
...
minetest.register_chatcommand("home", {
	...
	privs = {home = true},
	func = function(name)
		if gal.player.sethome.go(name) then
...
minetest.register_chatcommand("sethome", {
	...
	func = function(name)
		...
		local player = minetest.get_player_by_name(name)
		if player and gal.player.sethome.set(name, player:get_pos()) then
