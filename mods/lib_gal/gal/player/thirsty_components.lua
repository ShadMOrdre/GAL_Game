...
if thirsty.config.register_vessels then		--if minetest.get_modpath("vessels") and thirsty.config.register_vessels then
    ...
    thirsty.augment_item_for_drinking('lib_materials:vessel_glass_glass', 22)
    thirsty.augment_item_for_drinking('lib_materials:vessel_jar_glass', 24)
    thirsty.augment_item_for_drinking('lib_materials:vessel_jug_glass', 26)
end

if thirsty.config.register_bowl then		--if minetest.get_modpath("default") and thirsty.config.register_bowl then
    -- our own simple wooden bowl
    minetest.register_craftitem('lib_player:wooden_bowl', {
...
if thirsty.config.register_canteens then		--if minetest.get_modpath("default") and thirsty.config.register_canteens then

    minetest.register_tool('lib_player:steel_canteen', {
    ...
    minetest.register_tool('lib_player:bronze_canteen', {
    ...
    minetest.register_craft({
        output = "lib_player:steel_canteen",
        recipe = {
            { "group:wood", ""},
    ...
    minetest.register_craft({
        output = "lib_player:bronze_canteen",
        recipe = {
            { "group:wood", ""},
...
if thirsty.config.register_drinking_fountain then		--if minetest.get_modpath("default") and minetest.get_modpath("bucket") and thirsty.config.register_drinking_fountain then

    minetest.register_node('lib_player:drinking_fountain', {
    ...
    minetest.register_craft({
        output = "lib_player:drinking_fountain",
        recipe = {
...
if thirsty.config.register_fountains then		--if minetest.get_modpath("default") and minetest.get_modpath("bucket") and thirsty.config.register_fountains then

    minetest.register_node('lib_player:water_fountain', {
    ...
    minetest.register_node('lib_player:water_extender', {
    ...
    minetest.register_craft({
        output = "lib_player:water_fountain",
        recipe = {
    ...
    minetest.register_craft({
        output = "lib_player:water_extender",
        recipe = {
            { "", "bucket:bucket_water", ""},
            { "", "default:copper_ingot", ""},
            { "default:copper_ingot", "default:mese_crystal", "default:copper_ingot"}
    ...
    minetest.register_abm({
        nodenames = {'lib_player:water_fountain'},
        interval = 2,
        chance = 5,
...
if thirsty.config.register_amulets then		--if minetest.get_modpath("default") and minetest.get_modpath("bucket") and thirsty.config.register_amulets then

    minetest.register_craftitem('lib_player:injector', {
        description = 'Water injector',
        inventory_image = 'thirsty_injector.png',
    })
    minetest.register_craft({
        output = "lib_player:injector",
        recipe = {
    ...
    minetest.register_craftitem('lib_player:extractor', {
        description = 'Water extractor',
        inventory_image = 'thirsty_extractor.png',
    })
    minetest.register_craft({
        output = "lib_player:extractor",
        recipe = {
