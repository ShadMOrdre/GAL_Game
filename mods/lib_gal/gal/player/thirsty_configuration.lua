...
try_config_file(lib_player.path_mod .. "/" .. fileroot .. ".default.conf")

-- next, install-specific copy in modpath
try_config_file(lib_player.path_mod .. "/" .. fileroot .. ".conf")

-- last, world-specific copy in worldpath
try_config_file(lib_player.path_world .. "/" .. fileroot .. ".conf")
