...
dofile(lib_player.path_mod..'/thirsty_configuration.lua')
local C = M.config

dofile(lib_player.path_mod..'/thirsty_persistent_player_attributes.lua')
local PPA = M.persistent_player_attributes

thirsty.time_next_tick = thirsty.config.tick_time

dofile(lib_player.path_mod..'/thirsty_hud.lua')
dofile(lib_player.path_mod..'/thirsty_functions.lua')
...
dofile(lib_player.path_mod..'/thirsty_components.lua')
