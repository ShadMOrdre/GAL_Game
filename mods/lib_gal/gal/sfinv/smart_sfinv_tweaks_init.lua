...
local maininv = dofile(gal.sfinv.path_mod.."/smart_sfinv_tweaks_maininv.lua")

gal.sfinv.smart_sfinv_api.defaults.theme_inv = gal.sfinv.smart_sfinv_api.defaults.theme_inv ..
...
gal.sfinv.smart_sfinv_api.register_enhancement({
