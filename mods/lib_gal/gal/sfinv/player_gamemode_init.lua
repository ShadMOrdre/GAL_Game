...
dofile(gal.sfinv.path_mod .. "/player_gamemode_ChatCmdBuilder.lua")
...
if gal.sfinv.creative.is_enabled_for then
	gal.sfinv.creative.is_enabled_for = perplayer_gamemode.is_enabled_for
else
	for name, def in pairs(gal.sfinv.pages) do
