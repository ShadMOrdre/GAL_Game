...
gal.lib.shapes.register_fence_node = function(node_mat, shape)
	...
	new_node_def = {
		...
		paramtype = "light",
		paramtype2 = "facedir",
		connects_to = { "group:wall", "group:stone", "group:lib_fence", "group:lib_doors", "group:lib_fences", "group:lib_general", "group:lib_shaped_node" },
...
gal.lib.shapes.register_fence_set = function(node_mat)

	gal.lib.shapes.register_fence_node(node_mat, "fence")
	gal.lib.shapes.register_fence_node(node_mat, "fence_stone_cobble_post")

	gal.lib.shapes.register_fence_node(node_mat, "rail")
	gal.lib.shapes.register_fence_node(node_mat, "rail_stair")
	gal.lib.shapes.register_fence_node(node_mat, "rail_post")
