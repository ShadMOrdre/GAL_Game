...
local palettes1
local palettes2
if gal_geology.palette_select == "alt" then
	palettes1 = palettes1_alt
	palettes2 = palettes2_alt
elseif gal_geology.palette_select == "duane" then
...
local textures = {}
if gal_geology.color_grass_use == "true" then
		textures = {
			humid = {
...
for i, stone in ipairs(gal.lib.csv.read("|", gal_geology.path .. "/" .. gal_geology.nodes_data_file .. ".csv")) do
	...
	if new_node_type == 2 then
		...
		if gal_geology.color_grass_reg == "true" then
		...
		elseif not string.find(node_name, "gravel") then
			...
			elseif string.find(node_name, "pounamu") or string.find(node_name, "rhyolitic_tuff") or string.find(node_name, "sandstone_desert_stone") or string.find(node_name, "sandstone_old_red") then
				gal.lib.shapes.register_basic_set(""..node_name.."")
			elseif string.find(node_name, "sandstone_white") or string.find(node_name, "schist_02") or string.find(node_name, "sea") or string.find(node_name, "siltstone") then
				gal.lib.shapes.register_basic_set(""..node_name.."")
