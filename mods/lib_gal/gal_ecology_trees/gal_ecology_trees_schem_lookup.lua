...
local lookup = function(schem_name, node_set)
	...
	local NS = {}
	local N = gal_ecology_trees.N or {}
	...
	local ttrunk = NS["T"] or "gal:tree_" .. sch_name .. "_trunk"
	local tleaves = NS["L"] or "gal:tree_" .. sch_name .. "_leaves"

	local x1vine, x2vine, x3vine
	if minetest.registered_nodes["gal:plant_vine_" .. sch_name] then
		x1vine = "gal:plant_vine_" .. sch_name
	else
		x1vine = "gal:plant_vine_01"
	end
	if minetest.registered_nodes["gal:plant_vine_" .. sch_name .. "_liana"] then
		x2vine = "gal:plant_vine_" .. sch_name .. "_liana"
	end
	if minetest.registered_nodes["gal:plant_vine_" .. sch_name .. "_flowers"] then
		x3vine = "gal:plant_vine_" .. sch_name .. "_flowers"
	end
	...
	local xfruit
	if minetest.registered_nodes["gal:fruit_" .. sch_name] then
		xfruit = "gal:fruit_" .. sch_name
	elseif minetest.registered_nodes["gal:fruit_" .. sch_name .. "_cone"] then
		xfruit = "gal:fruit_" .. sch_name .. "_cone"
	elseif minetest.registered_nodes["gal:fruit_" .. sch_name:gsub("palm_", "") .. "_coconut"] then
		xfruit = "gal:fruit_coconut"
	elseif minetest.registered_nodes["gal:fruit_" .. sch_name:gsub("palm_", "") .. "_dates"] then
		xfruit = "gal:fruit_dates"
	elseif string.find(sch_name, "oak") then
		xfruit = "gal:fruit_acorn"
	else
		xfruit = "air"
	end
	...
	N["ddddd"] = {name = "gal:dirt", param2 = 0, prob = 254}
	N["S0m00"] = {name = "gal:stone", param2 = 0, prob = 254}
	N["__mb_"] = {name = "gal:mushroom_brown",param2 = 0,prob = 127}
	N["__mr_"] = {name = "gal:mushroom_red",param2 = 0,prob = 127}
	N["__mp_"] = {name = "gal:mushroom_purple",param2 = 0,prob = 127}
