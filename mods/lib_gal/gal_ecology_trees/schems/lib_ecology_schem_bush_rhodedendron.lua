...
gal_ecology_trees.schematics.insert("schem_bush_rhodedendron", le_temp_schem)
...
gal_ecology_trees.schematics.insert("schem_bush_rhodedendron_blooming", le_temp_schem)
