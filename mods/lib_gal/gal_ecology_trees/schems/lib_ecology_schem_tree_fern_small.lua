...
gal_ecology_trees.schematics.insert("schem_tree_fern_small_01", le_temp_schem)
...
gal_ecology_trees.schematics.insert("schem_tree_fern_small_02", le_temp_schem)
...
gal_ecology_trees.schematics.insert("schem_tree_fern_small", le_temp_schem)
