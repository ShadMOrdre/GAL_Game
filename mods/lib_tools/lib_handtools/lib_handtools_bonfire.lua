...
minetest.register_entity("lib_handtools:bonfire_item",{
	hp_max = 1,
	visual="wielditem",
...
local remove_item = function(pos, node)
	...
	if objs then
		for _, obj in ipairs(objs) do
			if obj and obj:get_luaentity() and obj:get_luaentity().name == "lib_handtools:bonfire_item" then
				obj:remove()
			end
		end
	end
...
local update_item = function(pos, node)
	...
	if not inv:is_empty("input") then
		...
		local e = minetest.add_entity(pos,"lib_handtools:bonfire_item")
...
minetest.register_node("lib_handtools:bonfire_unlit", {
	description = "Bonfire",
	drawtype = "plantlike",
	visual_scale = 1.0,
	tiles = {"lib_materials_tool_bonfire_unlit.png"},
	inventory_image = "lib_materials_tool_bonfire_unlit.png",
	wield_image = "lib_materials_tool_bonfire_unlit.png",
	paramtype = "light",
...
minetest.register_node("lib_handtools:bonfire", {
	drawtype = "plantlike",
	...
	inventory_image = "lib_materials_tool_bonfire_unlit",
	wield_image = "lib_materials_tool_bonfire_unlit",
	paramtype  = "light",
	paramtype2 = "facedir",
	sunlight_propagates = true,
	walkable = false,
...
minetest.register_lbm({
	name = "lib_handtools:bonfire_item_restoration",
