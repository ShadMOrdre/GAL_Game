...
connected_chests.register_chest("lib_chests:chest", {
	...
	on_rightclick = function(pos, _, player)
		...
		minetest.show_formspec(
			...
			"lib_chests:chest_locked_connected_left",
			"size[13,9]"..
...
connected_chests.register_chest("lib_chests:chest_locked", {
	get_formspec = function()
		return big_formspec
	end,
	lock = true,
...
-- legacy
minetest.register_alias("connected_chests:chest_left", "lib_chests:chest_connected_left")
minetest.register_alias("connected_chests:chest_right", "lib_chests:chest_connected_right")
minetest.register_alias("connected_chests:chest_left_locked", "lib_chests:chest_locked_connected_left")
minetest.register_alias("connected_chests:chest_right_locked", "lib_chests:chest_locked_connected_right")
