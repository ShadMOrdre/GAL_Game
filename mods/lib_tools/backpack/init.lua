...
minetest.register_on_joinplayer(function(player)
	...
	if minetest.get_modpath("gal") ~= nil then
			gal.sfinv.buttons.register_button("backpack", {
      ...
      initial_properties =
         {
            hp_max = BAG_MAX_HP,
            physical = false,
            collisionbox = { -0.44, -0.5, -0.425, 0.44, 0.35, 0.425 },--collisionbox = { -0.2, -0.3, -0.2, 0.2, 0.3, 0.2 },--collisionbox = { -0.44, -0.5, -0.425, 0.44, 0.35, 0.425 },
            visual = "mesh",
            visual_size = { x = 1, y = 1 },
            mesh = "backpack.obj",
...
-- local button_action = function(player)
	-- dropbackpack(player:get_player_name())
-- end
