...
--if gal.player.armor.materials.wood then
		gal.player.armor:register_armor("3d_armor_gloves:gloves_wood", {
...
--if gal.player.armor.materials.cactus then
		gal.player.armor:register_armor("3d_armor_gloves:gloves_cactus", {
...
--if gal.player.armor.materials.steel then
		gal.player.armor:register_armor("3d_armor_gloves:gloves_steel", {
...
--if gal.player.armor.materials.bronze then
		gal.player.armor:register_armor("3d_armor_gloves:gloves_bronze", {
...
--if gal.player.armor.materials.diamond then
		gal.player.armor:register_armor("3d_armor_gloves:gloves_diamond", {
...
--if gal.player.armor.materials.gold then
		gal.player.armor:register_armor("3d_armor_gloves:gloves_gold", {
...
--if gal.player.armor.materials.mithril then
		gal.player.armor:register_armor("3d_armor_gloves:gloves_mithril", {
...
--if gal.player.armor.materials.crystal then
		gal.player.armor:register_armor("3d_armor_gloves:gloves_crystal", {
