...
armor = {
	...
	materials = {
		...
		bone = nil,						--**Used for clothing/armor.       {mobs_redo:bone}
		leather = nil,						--**Used for clothing/armor.       {mobs_redo:leather, lib_textiles:leather}
		leather_black = nil,
		leather_brown = nil,
		leather_grey = nil,
	...
	fire_nodes = {
		{"lib_materials:liquid_lava_cooling_flowing",            5, 8},
		{"lib_materials:liquid_lava_cooling_source",            5, 8},
		{"lib_materials:liquid_lava_flowing",            5, 8},
		{"lib_materials:liquid_lava_source",            5, 8},
		{"lib_materials:fire_flame_basic",           3, 4},
		{"lib_materials:fire_flame_permanent",            3, 4},
		{"torch:torch",           1, 1},
...
armor.update_player_skin = function(self, player, skin_texture)
	if not player then
		return
	end
