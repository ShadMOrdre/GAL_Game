--
-- Register lib_mob_resources craftitems
--

for i, ci in ipairs(lib_mob_resources.read_csv("|", lib_mob_resources.path_mod .. "/craftitems.csv")) do
	...
	if citem then
		if citem ~= "" then
			...
			minetest.register_craftitem("lib_mob_resources:" .. citem, new_ci_def)
