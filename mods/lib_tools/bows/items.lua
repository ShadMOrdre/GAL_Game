...
minetest.register_node("bows:target", {
	description = "Target",
	tiles = {"lib_ecology_tree_default_wood.png","lib_ecology_tree_default_wood.png","lib_ecology_tree_default_wood.png","lib_ecology_tree_default_wood.png","lib_ecology_tree_default_wood.png","lib_ecology_tree_default_wood.png^bows_target.png","lib_ecology_tree_default_wood.png"},
	groups = {choppy = 2, oddly_breakable_by_hand = 2,mesecon = 2},
	drawtype="nodebox",
	node_box = {
		type = "fixed",
